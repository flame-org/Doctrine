...
use Flame\Doctrine\MemberAccessException;
use Flame\Doctrine\UnexpectedValueException;
...
abstract class BaseEntity extends \Nette\Object implements IEntity
{
	 ...
	 *
	 * @throws \Flame\Doctrine\UnexpectedValueException
	 * @throws \Flame\Doctrine\MemberAccessException
	 * @return mixed
	 */
